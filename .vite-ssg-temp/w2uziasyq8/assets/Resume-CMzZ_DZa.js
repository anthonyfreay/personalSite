...
const Resume = () => {
  ...
  return /* @__PURE__ */ jsxs("div", {
    className: ResumeStyle["resume-container"], children: [
    ...
    /* @__PURE__ */ jsx(NavBar, {}),
    /* @__PURE__ */ jsx("div", {
      className: ResumeStyle["resume-content"], children: /* @__PURE__ */ jsxs("div", {
        className: ResumeStyle["resume-viewer"], children: [
      /* @__PURE__ */ jsxs("div", {
          className: ResumeStyle["resume-header"], children: [
        /* @__PURE__ */ jsx("h1", { children: "Résumé" }),
        /* @__PURE__ */ jsxs("div", {
            className: ResumeStyle["header-actions"], children: [
          /* @__PURE__ */ jsxs(
              "a",
              {
                href: resumePath,
      ...
      /* @__PURE__ */ jsx(
          Document,
          {
            ...
            loading: /* @__PURE__ */ jsxs("div", {
              className: ResumeStyle["pdf-loading"], role: "status", "aria-live": "polite", children: [
            /* @__PURE__ */ jsx("div", { className: ResumeStyle["spinner"] }),
            /* @__PURE__ */ jsx("p", { children: "Loading résumé..." })
              ]
            }),
            error: /* @__PURE__ */ jsxs("div", {
              className: ResumeStyle["pdf-error"], role: "alert", children: [
            ...
            children: Array.from(new Array(numPages), (el, index) => /* @__PURE__ */ jsxs("div", {
              className: ResumeStyle["page-wrapper"], children: [
            /* @__PURE__ */ jsx(
                Page,
                {
                  pageNumber: index + 1,
                ...
                numPages > 1 && /* @__PURE__ */ jsxs("div", {
                  className: ResumeStyle["page-indicator"], children: [
                    "Page ",
                    index + 1,
                    " of ",
                    numPages
