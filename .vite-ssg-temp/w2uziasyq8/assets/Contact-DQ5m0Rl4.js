...
const ContactForm = () => {
  ...
  return /* @__PURE__ */ jsxs("form", {
    ref: formRef, className: ContactFormStyle.contactForm, onSubmit: handleOnSubmit, children: [
    ...
    /* @__PURE__ */ jsxs("label", {
      htmlFor: "check", className: ContactFormStyle.terms, children: [
        "Terms of Service*",
    ...
    /* @__PURE__ */ jsxs("select", {
      className: ContactFormStyle.terms, name: "check", required: true, children: [
    ...
    /* @__PURE__ */ jsx("button", { type: "submit", className: ContactFormStyle.submit, disabled: state.submitting, children: "Submit" }),
      showThankYou && /* @__PURE__ */ jsxs("p", {
        className: `${ContactFormStyle.thankYouMessage} ${showThankYou ? ContactFormStyle["thankYouMessage-active"] : ""}`, children: [
...
const Contact = () => {
  return /* @__PURE__ */ jsxs("div", {
    className: ContactStyle.container, children: [
    /* @__PURE__ */ jsxs(Helmet, {
      ...
      /* @__PURE__ */ jsx("meta", { property: "og:image", content: "https://anthonyfreay.com/me/A7406500.jpg" }),
      ...
      /* @__PURE__ */ jsx("meta", { name: "twitter:image", content: "https://anthonyfreay.com/me/A7406500.jpg" })
      ]
    }),
    /* @__PURE__ */ jsx(PageHeader, { title: "Contact | Anthony Freay" }),
    /* @__PURE__ */ jsx(NavBar, { activePage: "contact" }),
    /* @__PURE__ */ jsx("div", {
      className: ContactStyle.mainContent, children: /* @__PURE__ */ jsxs("div", {
        className: ContactStyle.bioContainer, children: [
      /* @__PURE__ */ jsx("div", { className: ContactStyle.bioImage, children: /* @__PURE__ */ jsx("img", { src: "/me/A7406500.jpg", alt: "Anthony Freay", className: ContactStyle.profileImage }) }),
      /* @__PURE__ */ jsxs("div", {
          className: ContactStyle.bioDescription, children: [
        /* @__PURE__ */ jsxs("p", {
            className: ContactStyle.intro, children: [
